                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        ...
                        <div class="carousel-item {{$key == 2 ? 'active' : ''}}">
                            <img class="w-100 h-100" src="{{asset('assets/image/product/'.$image)}}" alt="Image">
                        </div>
                        @endif
                        @endforeach
                ...
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            <div wire:click.prevent="minus" class="input-group-btn">
                                <button class="btn btn-primary">
                                    <i class="fa fa-minus"></i>
                                </button>
                            </div>
                            <span type="text" class="form-control bg-secondary border-0 text-center"> {{$qty}} </span>
                            <div wire:click.prevent="plus" class="input-group-btn">
                                <button class="btn btn-primary">
                                    <i class="fa fa-plus"></i>
                                </button>
                            </div>
                        </div>
                        <button wire:click.prevent="addCart({{$products}})" class="btn btn-primary px-3"><i
