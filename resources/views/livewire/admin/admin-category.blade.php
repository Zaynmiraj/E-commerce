                ...
                <table class="sa-datatables-init" data-order='[[ 1, "asc" ]]' data-sa-search-input="#table-search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($category->image)
                                <img src="{{asset('assets/image/category/'.$category->image)}}"
                                    alt="{{$category->name}}" width="40px" height="40px" />
                                @else
                                <img src="{{asset('assets/default/default-img.png')}}" alt="{{$category->name}}"
