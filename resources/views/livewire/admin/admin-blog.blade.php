<div id="top" class="sa-app__body">
        ...
        <div class="container">
            <div class="py-5">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-auto d-flex"><a href="#" data-bs-toggle="modal" data-bs-target="#createBlog"
                            class="btn btn-primary">Create Blog
                        </a>
                    </div>
                </div>
            </div>
                ...
                <table class="sa-datatables-init" data-order='[[ 1, "asc" ]]' data-sa-search-input="#table-search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($item->image)
                                <img src="{{asset('assets/image/blog/'.$item->image)}}" alt="{{$item->title}}"
                                    width="40px" height="40px" />
                                @else
                                <img src="{{asset('assets/default/default-img.png')}}" alt="{{$item->title}}"
                                    width="40px" height="40px" />
                                @endif
                            </td>

                            <td><a href="app-category.html" class="text-reset"> {{$item->title}} </a></td>
                            <td>
                                <div class="badge">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end"
                                        ...
                                        <li><a onclick="EditBlog({{$item->id}})" class="dropdown-item" href=""
                                                data-bs-target="#EditBlog" data-bs-toggle="modal">Update</a></li>
                                        <li>
    ...
    <div wire:ignore class="modal fade" id="createBlog" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <form wire:submit.prevent="store" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Create a blog</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input wire:keyup="makeSlug" type="text" class="form-control rounded border"
                                placeholder="Sponsor Name" wire:model="title" required />
                        </div>
                        <div class="form-group">
                            <label for="form-label"> Description</label>
                            <textarea type="text" class="form-control rounded border" cols="2" rows="4"
                                placeholder="Description" wire:model="description" required> </textarea>
                        </div>
                        <div class="form-group">
                            <label for="form-label"> Button Link </label>
...
<script type="text/javascript">
    function EditBlog(id){
        ...
        success: function(data){
            $('.edit-modal').append(
                `<div class="form-group">
                    <input type="hhidden" name="id" value="${data.id}" />
                    <label for="form-label">Title </label>
                    <input value="${data.title}" type="text" class="form-control rounded border" placeholder="Blog Title"
                        name="title" required />
                </div>
                <div class="form-group">
                    <label for="form-label"> Description</label>
                    <textarea type="text" class="form-control rounded border" cols="2" rows="4" placeholder="Description"
                        name="description" required> ${data.description} </textarea>
                </div>
                <div class="form-group">
                    <label for="form-label"> Button Link </label>
                    <input value="${data.btn_link}" type="text" class="form-control rounded border" placeholder="https://www...." name="link" required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="flex flex-row items-center">
                        <img src="{{asset('assets/image/blog/${data.image}')}}" width="200px" />
