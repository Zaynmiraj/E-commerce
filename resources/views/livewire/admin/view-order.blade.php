                                ...
                                <table class="sa-table">
                                    <tbody>
                                        <tr>
                                            <td class="min-w-20x">
                                                <div class="d-flex align-items-center">
                                                    <img src="images/products/product-2-40x40.jpg" class="me-4"
                                                        width="40" height="40" alt="" />
                                                    <a href="app-product.html" class="text-reset">Brandix Brake Kit
                                                        BDX-750Z370-S</a>
                                                </div>
                                            </td>
                                            <td class="text-end">
                                        ...
                                        <tr>
                                            <td class="min-w-20x">
                                                <div class="d-flex align-items-center">
                                                    <img src="images/products/product-7-40x40.jpg" class="me-4"
                                                        width="40" height="40" alt="" />
                                                    <a href="app-product.html" class="text-reset">Glossy Gray 19&quot;
                                                        Aluminium Wheel
                                                        AR-19</a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="min-w-20x">
                                                <div class="d-flex align-items-center">
                                                    <img src="images/products/product-16-40x40.jpg" class="me-4"
                                                        width="40" height="40" alt="" />
                                                    <a href="app-product.html" class="text-reset">Twin Exhaust Pipe From
                                                        Brandix Z54</a>
                                                </div>
                                            </td>
                                            <td class="text-end">
