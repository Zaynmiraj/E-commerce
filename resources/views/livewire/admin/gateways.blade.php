<div id="top" class="sa-app__body">
        ...
        <div class="container">
            <div class="py-5">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-auto d-flex"><a href="#" data-bs-toggle="modal" data-bs-target="#addPayment"
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end"
                                        ...
                                        <li><a class="dropdown-item" href="#" data-bs-target="#EditGateway"
                                                onclick="EditGateway({{$item->id}})" data-bs-toggle="modal">Edit
                                                Item</a></li>
    ...
    <div wire:ignore class="modal fade" id="addPayment" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <form wire:submit.prevent="store" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Add Gateway</h1>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input wire:keyup="makeSlug" type="text" class="form-control rounded border"
                                        placeholder="Name" wire:model="name" required />
                                </div>

                                <div class="form-group">
                                    <label for="form-label"> Secret Key </label>
                                    <input type="text" class="form-control rounded border" placeholder="key"
                                        wire:model="secret" />
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Public Key </label>
                                    <input type="text" class="form-control rounded border" wire:model="public"
                                        placeholder="key" />
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label for="form-label"> Mode </label>
                                    <select class="form-control rounded border" wire:model="mode">
                                ...
                                <div class="form-group">
                                    <div class="fileupload">
                                        <label class="label-text">Choose Icon </label>
                                        <input type="file" class="form-control" wire:model="icon"
                                            onchange="previewImage(event)" />
                                    </div>

                                    <img id="preview" alt="Preview Image" width="200px" style="display: none">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <form method="POST" action="{{route('update-gateway')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Update Method</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
        ...
        success: function(data){
            ...
            `<div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                        <label for="form-label"> Secret Key </label>
                        <input value="${data.secret_key ? data.secret_key : ''}" type="text" class="form-control rounded border" placeholder="key" name="secret" />
                    </div>
                    <div class="form-group">
                        <label class="form-label">Public Key </label>
                        <input value="${data.public_key ? data.secret_key : ''}" type="text" class="form-control rounded border" name="public" placeholder="key" />
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        <label for="form-label"> Mode </label>
                        <select class="form-control rounded border" name="mode">
                            ${data.status == 1 ?
                            `<option value="1"> Live </option>
                    ...
                    <div class="form-group">
                        <div class="fileupload">
                            <label class="label-text">Choose Icon </label>
                            <input type="file" class="form-control" name="icon" onchange="previewImages(event)" />
                        </div>
                        <div class="d-flex">
                            <img src="{{asset('assets/image/gateway/${data.icon}')}}" width="100px" />
                            <img id="previews" alt="Preview Image" width="100px" style="display: none">
                        </div>
                    </div>
                </div>
            </div>`
