<div id="top" class="sa-app__body">
        ...
        <div class="container">
            <div class="py-5">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-auto d-flex"><a href="#" data-bs-toggle="modal" data-bs-target="#addLink"
                            class="btn btn-primary">Add New Link</a>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <table class="sa-datatables-init" data-order='[[ 1, "asc" ]]' data-sa-search-input="#table-search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($item->icon)
                                <img src="{{asset('assets/image/social/'.$item->icon)}}" alt="{{$item->name}}"
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end"
                                        ...
                                        <li><a class="dropdown-item" href="#" data-bs-target="#EditLink"
                                                onclick="EditLink({{$item->id}})" data-bs-toggle="modal">Edit
                                            </a></li>
    ...
    <div wire:ignore class="modal fade" id="addLink" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-l">
            <div class="modal-content">
                <form wire:submit.prevent="store" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Add Social Link</h1>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label for="form-label"> Social Link </label>
                                <input type="text" class="form-control rounded border"
                                    placeholder="http://www.example.com" wire:model="url" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="fileupload">
                                    ...
                                    <input type="file" onchange="previewImage(event)"
                                        class="form-control rounded border" wire:model="icon" placeholder="key" />
                                </div>
    ...
    <div class="modal fade" id="EditLink" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <form method="POST" action="{{route('update-link')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Update Link</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            `<div class="row">
                ...
                <div class="form-group">
                    <label for="form-label"> Social Link </label>
                    <input value="${data.url}" type="text" class="form-control rounded border" placeholder="http://www.example.com"
                        name="url" />
                </div>
                <div class="form-group">
                    <label class="form-label">Status</label>
                    <select class="form-control border rounded" name="status">
                        ${data.status == 1 ? `
                        <option value="1">Active</option>
                ...
                <div class="form-group">
                    <div class="fileupload">
                        <label class="label-text">Choose Icon</label>
                        <input type="file" class="form-control rounded border" name="icon" />
                    </div
                    <div class="d-flex">
                        <img src="{{asset('assets/image/social/${data.icon}')}}" width="100px" />
                        <img id="previews" style="display: none;" width="100px"  />
                </div>
            </div>`
            )
        }
