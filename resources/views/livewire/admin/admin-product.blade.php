                        ...
                        <li class="sa-filters__item">
                            ...
                            <div class="sa-filters__item-body">
                                <ul class="list-unstyled m-0 mt-n2">
                                    <li>
                                        <label class="d-flex align-items-center pt-2">
                                            <input type="radio" class="form-check-input m-0 me-3 fs-exact-16"
                                                name="filter-product_type" checked="" />
                                            Simple
                                        </label>
                                    </li>
                                    <li>
                    ...
                    <table class="sa-datatables-init" data-order='[[ 1, "asc" ]]' data-sa-search-input="#table-search">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="app-product.html" class="me-4">
                                            <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                @if($product->image)
                                                <img src="{{asset('assets/image/product/'. $product->image)}}"
                                        ...
                                        <div>
                                            <a href="app-product.html" class="text-reset"> {{$product->product_name}}
                                            </a>
                                                ...
                                                <ul class="sa-meta__list">
                                                    <li class="sa-meta__item">
                                                        ...
                                                        <span title="Click to copy product ID"
                                                            class="st-copy">{{$product->product_id}}</span>
                                                    </li>
                                                    <li class="sa-meta__item">
                                                        SKU:
                                                        <span title="Click to copy product SKU" class="st-copy">
                                                            {{$product->sku}} </span>
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <td><a href="app-category.html" class="text-reset">{{$product->category->name}}</a></td>
                                <td>
                                    <div class="badge badge-sa-success">{{$product->stock_quantity}} In Stock</div>
                                </td>
                                <td>
                                    <div class="sa-price">
                                        <span class="sa-price__symbol">$</span>
                                        <span class="sa-price__integer">{{$product->sale_price}}</span>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end"
                                            ...
                                            <li><a class="dropdown-item text-danger" href="javascript:void(0)"
                                                    wire:click="delete({{$product->id}})">Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
