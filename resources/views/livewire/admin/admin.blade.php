<div class="sa-app sa-app--desktop-sidebar-shown sa-app--mobile-sidebar-hidden sa-app--toolbar-fixed">
    <!-- sa-app__sidebar -->
    <div class="sa-app__sidebar z-index-100">
        <div class="sa-sidebar">
            <div class="sa-sidebar__header">
                <a class="sa-sidebar__logo" href="{{route('/')}}">
                    <!-- logo -->
                    ...
                    <li class="sa-nav__section">
                        ...
                        <ul class="sa-nav__menu sa-nav__menu--root">
                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                <a href="{{route('/')}}" class="sa-nav__link">
                            ...
                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                ...
                                <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                    <li class="sa-nav__menu-item">
                                        <a href="{{route('products')}}" class="sa-nav__link">
                                            <span class="sa-nav__menu-item-padding"></span>
                                            <span class="sa-nav__title">Products</span>
                                        </a>
                                    </li>
                                    <li class="sa-nav__menu-item">
                                        <a href="{{route('categories')}}" class="sa-nav__link">
                                            <span class="sa-nav__menu-item-padding"></span>
                                            <span class="sa-nav__title">Categories</span>
                                        </a>
                                    </li>
                                    <li class="sa-nav__menu-item">
                                        <a href="{{route('sliders')}}" class="sa-nav__link">
                                            <span class="sa-nav__menu-item-padding"></span>
                                            <span class="sa-nav__title">Slider</span>
                                        </a>
                                    </li>
                                    <li class="sa-nav__menu-item">
                                        <a href="{{route('banners')}}" class="sa-nav__link">
                                            <span class="sa-nav__menu-item-padding"></span>
                                            <span class="sa-nav__title">Banners</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                ...
                                <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                    <li class="sa-nav__menu-item">
                                        <a href="{{route('customers')}}" class="sa-nav__link">
                                            <span class="sa-nav__menu-item-padding"></span>
                                            <span class="sa-nav__title">Customers</span>
                                        </a>
                                    </li>
                            ...
                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                ...
                                <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                    <li class="sa-nav__menu-item">
                                        <a href="{{route('orders')}}" class="sa-nav__link">
                                            <span class="sa-nav__menu-item-padding"></span>
                                            <span class="sa-nav__title">Orders</span>
                                        </a>
                                    </li>
                            ...
                            <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                <a href="{{route('chats')}}" class="sa-nav__link">
