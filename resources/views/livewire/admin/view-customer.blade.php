                ...
                <div class="sa-entity-layout__body">
                            ...
                            <div class="card-body d-flex flex-column align-items-center">
                                <div class="pt-3">
                                    <div class="sa-symbol sa-symbol--shape--circle" style="--sa-symbol--size: 6rem">
                                        <img src="images/customers/customer-1-96x96.jpg" width="96" height="96"
                                            alt="" />
                                    </div>
                                </div>
                    ...
                    <div class="sa-entity-layout__main">
                        <div class="sa-card-area">
                            <textarea class="sa-card-area__area" rows="2" placeholder="Notes about customer"></textarea>
                        ...
                        <div class="card mt-5">
                            ...
                            <div class="px-5 py-4 text-center"><a href="app-orders-list.html">View all 7 orders</a>
                            </div>
                        </div>
                        <div class="card mt-5">
                            <div class="card-body px-5 py-4 d-flex align-items-center justify-content-between">
                            ...
                            <div class="px-5 py-3 my-2 d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <div class="text-muted fs-exact-14 mt-1">Random Federation 115302, Moscow ul.
                                        Varshavskaya, 15-2-178</div>
                                </div>
                                <div>
                                    <div class="dropdown">
                                        <button class="btn btn-sa-muted btn-sm" type="button"
                                            id="address-context-menu-0" data-bs-toggle="dropdown" aria-expanded="false"
                                            aria-label="More">
                            ...
                            <div class="px-5 py-3 my-2 d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <div class="text-muted fs-exact-14 mt-1">Earth 4b4f53, MarsGrad Sun Orbit,
                                        43.3241-85.239</div>
                                </div>
                                <div>
                                    <div class="dropdown">
                                        <button class="btn btn-sa-muted btn-sm" type="button"
                                            id="address-context-menu-1" data-bs-toggle="dropdown" aria-expanded="false"
                                            aria-label="More">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="3" height="13"
                                                fill="currentColor">
                                                <path
